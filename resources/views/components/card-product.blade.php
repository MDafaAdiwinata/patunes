<div class="container px-6 py-10 sm:px-6 lg:px-8 lg:py-20 mx-auto">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="group flex flex-col h-full bg-white border border-black/10 shadow-2xs rounded-xl">
            <img src="https://images.unsplash.com/photo-1595309849731-f7ce86eda9fc?q=80&w=1583&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="w-full h-40 md:h-60 object-cover flex flex-col justify-center items-center rounded-t-xl" />
            <div class="p-4 md:p-6">
                ...
                <p class="mt-3 text-[#2a2a2a]/80 font-light">
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nostrum odio velit nisi pariatur, ad iure blanditiis rem accusantium rerum illum!
                </p>
            </div>
