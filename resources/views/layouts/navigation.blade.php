<nav x-data="{ open: false }" class="bg-white border-b border-black/10">
    ...
    <div class="container mx-auto px-6 md:px-0">
        <div class="flex justify-between items-center h-16">
            ...
            <!-- Navigation Links -->
            <div class="hidden sm:flex flex-1 justify-center gap-2">

                @if (Auth::user()->role === 'admin')
                    <x-nav-link :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')">
                        Dashboard
                    </x-nav-link>
                    <x-nav-link :href="route('admin.kelola-brand')" :active="request()->routeIs('admin.kelola-brand')">
                        Brand
                    </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if (Auth::user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.kelola-brand')" :active="request()->routeIs('admin.kelola-brand')">
                    {{ __('Brand') }}
                </x-responsive-nav-link>
