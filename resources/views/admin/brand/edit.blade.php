                ...
                <div class="w-full md:w-1/2">
                    ...
                    <div class="mt-6">
                        ...
                        <x-text-input id="nama" class="block mt-1 w-full bg-transparent" type="text"
                            :value="$brand->nama" name="nama" placeholder="contoh: Ventela, Compass ..." required />
                    ...
                    <div class="mt-6">
                        ...
                        <x-text-input id="tagline" class="block mt-1 w-full bg-transparent" type="text"
                            name="tagline" :value="$brand->tagline" placeholder="Contoh: Toko Sepatu Indonesia ..." required />
                    ...
                    <div class="mt-6">
                        ...
                        <x-text-input id="url" class="block mt-1 w-full bg-transparent" type="text"
                            name="url" :value="$brand->url" placeholder="https://..." required />
                    ...
                    <div class="mt-6">
                        ...
                        <textarea
                            ...
                            required name="deskripsi" rows="4" placeholder="Deskripsi Brand" data-hs-textarea-auto-height="">{{ $brand->deskripsi }}</textarea>
