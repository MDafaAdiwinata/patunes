                ...
                <div class="w-full md:w-1/2 mx-auto">
                    ...
                    <div class="mt-6">
                        ...
                        <x-text-input id="nama" class="block mt-1 w-full bg-transparent" type="text"
                            name="nama" :value="old('nama')" placeholder="contoh: Sneakers, Sports ..." required />
                    ...
                    <div class="mt-6">
                        ...
                        <textarea
                            ...
                            required name="deskripsi" rows="4" placeholder="Deskripsi Kategori" data-hs-textarea-auto-height="">{{ old('deskripsi') }}</textarea>
