                ...
                <div
                    ...
                    <table class="min-w-full divide-y divide-black/10">
                        <thead class="bg-[#607896]/10">
                            <tr>
                                <th scope="col"
                                    class="px-6 py-3 text-start text-base font-semibold text-[#151515]/80">Nama Lengkap
                                </th>
                                <th scope="col"
                                    class="px-6 py-3 text-start text-base font-semibold text-[#151515]/80">Email</th>
                                <th scope="col"
                                    class="px-6 py-3 text-start text-base font-semibold text-[#151515]/80">Subjek
                                </th>
                                <th scope="col"
                                    class="px-6 py-3 text-start text-base font-semibold text-[#151515]/80">Pesan
                                </th>
                                <th scope="col" class="px-6 py-3 text-base font-semibold text-[#151515]/80 text-start">
                                    Waktu
                                </th>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6"
                                        ...
                                        Maaf, data Feedback belum tersedia.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
